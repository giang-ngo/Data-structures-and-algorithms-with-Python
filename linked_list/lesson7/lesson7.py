from linked_list.lesson7.student import Student
...
def show_searched_result(target: Student, result: Student):
    if result is None:
        print(f'==> Không tìm thấy sinh viên mã {target.student_id}.')
    else:
        print(f'==> Tìm thấy sinh viên mã {target.student_id}.')
        print(result)
...
def test():
    ...
    print('==> Các phần tử trong DSLK: ')
    linked_list_students.show_elements()

    # giả sử ta tìm sinh viên theo mã
    s = Student(student_id='SV1005')
    searched_result = linked_list_students.search(s)
    show_searched_result(s, searched_result)

    s2 = Student(student_id='SV1010')
    searched_result = linked_list_students.search(s2)
    show_searched_result(s2, searched_result)
